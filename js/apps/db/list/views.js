...
(function() {
  ...
  define(['apps/db/list/templates', 'views/_base', 'd3'], function(Templates, AppView) {
    var DataVisLayout, _item, _ref, _ref1;
    return {
      DataVis: _item = (function(_super) {
        ...
        _item.prototype.onRender = function() {
          ...
          root.radius = 0;
          root.fixed = true;
          force = d3.layout.force().gravity(0.055).charge(function(d, i) {
            if (i) {
              return 0;
            } else {
              return -2000;
