define ["backbone"], (Backbone) ->
    ...
    Model: class _Model extends Backbone.Model
        ...
        saveError: (model, xhr, options) =>
        	...
        	@set _errors: $.parseJSON(xhr.responseText)?.errors unless xhr.status is 500 or xhr.status is 404 or xhr.status is 201
        
    Collection: class _Collection extends Backbone.Collection
