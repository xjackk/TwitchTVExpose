# app startup.
define ["backbone", "marionette", "msgbus", "nprogress"], (Backbone, Marionette, msgBus, NP) ->
    ...
    # handle custom events generated by our Backbone.sync override (see config)
    appChannel.on "sync:start", ->
        NP.start()
    appChannel.on "sync:stop", ->
        NP.done()
